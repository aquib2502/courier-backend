    ...
    Shipment: [
      {
        ...
        ConsignorAddressLine3: 400059,
        ConsignorCity: 'Mumbai',
        ConsignorPostCode: orderData.pincode,
        ConsignorState: orderData.state,
        ConsignorPhoneNo: orderData.mobile,
        GSTType: "GSTIN (Normal)",
        GSTIN: "27GWAPS7865D1Z1",
        ConsigneeName: orderData.invoiceName || orderData.firstName,
        ConsigneeContactPerson: orderData.invoiceName || orderData.firstName,
